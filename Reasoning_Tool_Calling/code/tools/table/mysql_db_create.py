...
def flights_db_loader():
    file_path = "/home/ubuntu/vdb1/Agent_design_architectures/ToolQA/data/external_corpus/external_corpus/flights/Combined_Flights_2022.csv"
...
def coffee_db_loader():
    file_path = "/home/ubuntu/vdb1/Agent_design_architectures/ToolQA/data/external_corpus/external_corpus/coffee/coffee_price.csv"
    data = pd.read_csv(file_path)
...
def airbnb_db_loader():
    file_path = "/home/ubuntu/vdb1/Agent_design_architectures/ToolQA/data/external_corpus/external_corpus/airbnb/Airbnb_Open_Data.csv"
    data = pd.read_csv(file_path)
    column_names = data.columns.to_list()
    data = data.fillna("---")
...
def yelp_db_loader():
    data_file = open("/home/ubuntu/vdb1/Agent_design_architectures/ToolQA/data/external_corpus/external_corpus/yelp/yelp_academic_dataset_business.json")
    data = []
