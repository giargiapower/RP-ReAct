...
import datetime
from prompts import reflect_prompt, react_agent_prompt
...
if args.gpt == "None" and args.local_model != "None":
    from agents import ReactReflectAgent, ReactAgent, ReflexionStrategy, ReactAgentLocal
elif args.gpt == "gpt3":
...
if args.debug:
    ...
    for i in range(len(contents)):
        ...
        agent = agent_cls(args, contents[i]['question'], contents[i]['answer'], local_llm, sampling_params, 20, react_agent_prompt)
        try:
            agent.run()
